...
public record VT<T1, T2>(T1 a, T2 b, string name, string nameA, string nameB)
{
	/// <summary>
	...
	{ }
	/// <inheritdoc/>
	public override string ToString() => $"{name} {{ {nameA} = {a}, {nameB} = {b} }}";
	...
	/// <returns></returns>
	public virtual bool Equals(VT<T1, T2> other) => name == other.name && Equals(a, other.a) && Equals(b, other.b);
