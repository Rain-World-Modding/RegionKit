...
namespace RegionKit.Modules.DevUIMisc.GenericNodes
{
	...
	public class FilePicker : Panel
	{
		...
		private void Populate()
		{
			...
			if (searchBar == null)
			{
				searchBar = new StringControl(owner, "FilePicker_Search", this, new Vector2(10f + widthOfSearchText, size.y - 40f), size.x - 15f - widthOfSearchText, filterBy, StringControl.TextIsValidFilename) { sendSignal = false };
				subNodes.Add(searchBar);
			}
