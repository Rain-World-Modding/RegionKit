...
namespace RegionKit.Machinery
{
    ...
    public static class MachineryStatic
    {
        ...
        {
            RegisterManagedObject<SimplePiston, PistonData, ManagedRepresentation>("SimplePiston");
            RegisterManagedObject<PistonArray, PistonArrayData,ManagedRepresentation>("PistonArray");
            RegisterEmptyObjectType<MachineryCustomizer, ManagedRepresentation>("MachineryCustomizer");
            RegisterManagedObject<SimpleCog, SimpleCogData, ManagedRepresentation>("SimpleCog");
            RegisterManagedObject<RoomPowerManager, PowerManagerData, ManagedRepresentation>("PowerManager", true);
        }
