...
namespace RegionKit.Modules.Misc
{
	internal static class FadePaletteCombiner
	{
		...
		private static void RoomSettingsPage_ctor(On.DevInterface.RoomSettingsPage.orig_ctor orig, DevInterface.RoomSettingsPage self, DevInterface.DevUI owner, string IDstring, DevInterface.DevUINode parentNode, string name)
		{
			orig(self, owner, IDstring, parentNode, name);

			Panel panel = new FadePaletteCombinerPanel(owner, "Fade_Palette_Combiner_Panel", self, new Vector2(260f, 190f), new Vector2(210f, 85f), "Fade Palette Combiner");
		...
		public class FadePaletteCombinerPanel : Panel, IDevUISignals
		{
			...
			{
				subNodes.Add(new PaletteController(owner, "New_Palette", this, new Vector2(5, size.y - 20f), "New Palette:"));
				subNodes.Add(new Button(owner, "Save_New_Palette", this, new Vector2(5, size.y - 60f), 200f, "Save fade as new palette"));
				subNodes.Add(new DevUILabel(owner, "Label", this, new Vector2(5, size.y - 80f), 200f, "Output: palettes/combinedPalettes"));
			}
