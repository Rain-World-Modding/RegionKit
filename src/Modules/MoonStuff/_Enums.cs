namespace RegionKit.Modules.MoonStuff
{
	internal static class _Enums
	{
		...
		public static readonly PlacedObject.Type PoisonBerryVine = new PlacedObject.Type(nameof(PoisonBerryVine), false);

		public static readonly PlacedObject.Type ToxinFern = new PlacedObject.Type(nameof(ToxinFern), false);

		public static readonly PlacedObject.Type ItemCrate = new PlacedObject.Type(nameof(ItemCrate), false);
	}
}
