...
public class ColoredSnowRoomCamera
{
	...
	private static readonly PropertyInfo _RoomCamera_levelTexture = typeof(RoomCamera).GetProperty("levelTexture", BindingFlags.Public | BindingFlags.Instance);
	...
	public static void UpdateSnowLight(RoomCamera camera)
	{
		...
		if (cameraData.coloredSnowPalette != null)
		{
