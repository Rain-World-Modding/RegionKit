...
internal static class PopupsMod
{
	public static void Register()
	{
		...
		RegisterFullyManagedObjectType(settings.ToArray(), typeof(PopupTrigger), _Enums.RoomPopupTrigger, _Enums.MiscObjectsCategory);

		settings.Add(new Vector2Field("handle", new Vector2(-100, 40), Vector2Field.VectorReprType.circle));
		RegisterFullyManagedObjectType(settings.ToArray(), typeof(ResizeablePopupTrigger), _Enums.ResizeablePopupTrigger, _Enums.MiscObjectsCategory);
		settings.Pop();

		settings.Add(new Vector2Field("handle", new Vector2(40, 60), Vector2Field.VectorReprType.rect));
		RegisterFullyManagedObjectType(settings.ToArray(), typeof(RectanglePopupTrigger), _Enums.RectanglePopupTrigger, _Enums.MiscObjectsCategory);
		settings.Pop();
	}
